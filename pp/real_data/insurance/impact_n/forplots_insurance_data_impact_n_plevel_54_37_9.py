...
def run():
    ...
    for f in frac_of_train_dataset: # varying the number of trianing data points used by using fractions
        ...
        for lamb in Lamb:
            ...
            _, _, reg_nonpp_test_mean, reg_nonpp_test_std, reg_theta_hat_nonpp_norm = pp_estimator(epsilons, X_train, y_train, X_tr_frac, y_tr_frac, lamb, runs, eval_lamb=lamb, non_personalized=True)
