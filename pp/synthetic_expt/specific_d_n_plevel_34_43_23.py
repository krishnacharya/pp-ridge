...
if __name__ == "__main__":
    ...
    # lambds = [10, 25, 50, 75, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, \
    #           5000, 5500, 6000, 6500, 7000, 7500, 8000, 8500, 9000, 9500, 10000]
    new_lambs = [10000 + i for i in range(0, 40000, 1000)]
    

    runs = 10000

    # run(N, D, lambds, runs)
    run(N, D, new_lambs, runs)
