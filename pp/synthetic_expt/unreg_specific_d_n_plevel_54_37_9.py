...
def run(N, D, lambds, runs=10000):
    ...
    for d in D:
        ...
        for n in N:
            ...
            epsilons = set_epsilons(N_train, f_c=0.54, f_m=0.37, eps_c=0.09, eps_m=0.2, eps_l=1.0)
    ...
    df.to_csv(f'../csv_outputs/unreg_specific_{d}_{n}_plevel_54_37_9_result.csv', encoding='utf-8', index=False)
